...
public class Yacine2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yacine2);
        ...
        Intent i = getIntent();
        String jjj = i.getStringExtra(MainActivity.BUTTONS1);
        ...
        String la = preferenc.getString(Yacine2.bol2, "11");
        ...
        razx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (text1.getText().equals("E") && text2.getText().equals("T") && text3.getText().equals("U") && text4.getText().equals("D") && text5.getText().equals("E") && text6.getText().equals("S")) {
                    ...
                    editor.commit();
                    Intent secondeActivite = new Intent(Yacine2.this, Yacine3.class);
    ...
    private View.OnClickListener apple = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            raz6.setBackgroundColor(Color.RED);
