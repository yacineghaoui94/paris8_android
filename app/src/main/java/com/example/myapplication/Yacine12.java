...
public class Yacine12 extends Activity {
    public final static String bol12 = "ramosfav";
    public String pop12 = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yacine12);
        ...
        razx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (text1.getText().equals("A") && text2.getText().equals("F") && text3.getText().equals("C") && text4.getText().equals("D") && text5.getText().equals("Z")) {
                    ...
                    editor.putString(Yacine3.FAV, pop12);
                    editor.putString(bol12, "vrai");
                    editor.commit();
                    Intent secondeActivite = new Intent(Yacine12.this, Yacine.class);
                    secondeActivite.putExtra(BUTTONS3, pop12);
