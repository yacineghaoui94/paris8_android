...
public class Yacine6 extends Activity {
    public final static String FAV = "fav";
    public final static String bol6 = "faxxwqav1";
    public String pop6 = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yacine6);
        ...
        Intent f = getIntent();
        String jjj = f.getStringExtra(Yacine5.BUTTONS5);
        ...
        String la = preferenc.getString(Yacine6.bol6, "11");
        if (la.toString().equals("vrai")) {
            String ff = textv.getText().toString();
            float dd = Float.valueOf(ff);
            dd = dd - 10;
            pop6 = String.valueOf(dd);
            app.setEnabled(false);
            appler.setEnabled(false);
        } else {
            pop6 = textv.getText().toString();
        }

        razx.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (text1.getText().equals("C") && text2.getText().equals("L") && text3.getText().equals("O") && text4.getText().equals("U") && text5.getText().equals("S")) {
                    String kkkk = textv.getText().toString();
                    SharedPreferences preferences = getSharedPreferences("pref", 0);
                    SharedPreferences.Editor editor = preferences.edit();
                    editor.putString(Yacine3.FAV, pop6);
                    editor.putString(bol6, "vrai");
                    editor.commit();
                    Intent secondeActivite = new Intent(Yacine6.this, Yacine.class);
                    secondeActivite.putExtra(BUTTONS3, pop6);
    ...
    private View.OnClickListener apple = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            raz8.setBackgroundColor(Color.RED);
            raz12.setEnabled(false);
            raz12.setBackgroundColor(Color.RED);
            appler.setEnabled(false);
        }
    };
