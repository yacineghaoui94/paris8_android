...
public class Yacine11 extends Activity {
    public final static int CHOOSE_BUTTON_REQUEST = 3;
    public String pop11 = null;
    public final static String bol11 = "mehandorzki";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yacine11);
        ...
        String la = preferenc.getString(Yacine11.bol11, "11");
        if (la.toString().equals("vrai")) {
            String ff = textv.getText().toString();
            float dd = Float.valueOf(ff);
            dd = dd - 10;
            pop11 = String.valueOf(dd);
        } else {
            pop11 = textv.getText().toString();
        }
        razx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (text1.getText().equals("A") && text2.getText().equals("F") && text3.getText().equals("C") && text4.getText().equals("D") && text5.getText().equals("Z")) {
                    ...
                    editor.putString(bol11, "vrai");
                    editor.commit();
                    Intent secondeActivite = new Intent(Yacine11.this, Yacine12.class);
                    secondeActivite.putExtra(BUTTONS5, pop11);
