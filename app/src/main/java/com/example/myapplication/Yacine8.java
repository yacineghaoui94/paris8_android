...
public class Yacine8 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yacine8);
       ...
       app = (ImageButton) findViewById(R.id.app);
         razx = (ImageButton) findViewById(R.id.bot);
        ...
        String la = preferenc.getString(Yacine8.bol8, "11");
        ...
        razx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (text1.getText().equals("A") && text2.getText().equals("F") && text3.getText().equals("C") && text4.getText().equals("D") && text5.getText().equals("Z")) {
                    ...
                    Intent secondeActivite = new Intent(Yacine8.this, Yacine9.class);
    ...
    private View.OnClickListener apple2 = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            // Uri Yacine = Uri.parse("http://www.google.com");
            // Intent secondeActivite = new Intent(Intent.ACTION_VIEW, Yacine);
