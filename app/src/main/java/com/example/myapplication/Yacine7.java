...
public class Yacine7 extends Activity {
    public final static int CHOOSE_BUTTON_REQUEST = 3;
    public final static String BUTTONS4 = "sBoutons";
    public String pop7 = null;
    public final static String bol7 = "razns";
    int not = 15;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yacine7);
        ...
        String la = preferenc.getString(Yacine7.bol7, "11");
        if (la.toString().equals("vrai")) {
            String ff = textv.getText().toString();
            float dd = Float.valueOf(ff);
            dd = dd - 10;
            pop7 = String.valueOf(dd);
        } else {
            pop7 = textv.getText().toString();
        }
        ...
        razx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (text1.getText().equals("A") && text2.getText().equals("F") && text3.getText().equals("C") && text4.getText().equals("D") && text5.getText().equals("Z")) {
                    ...
                    editor.putString(bol7, "vrai");
                    editor.commit();
                    Intent secondeActivite = new Intent(Yacine7.this, Yacine8.class);
                    secondeActivite.putExtra(BUTTONS4, pop7);
