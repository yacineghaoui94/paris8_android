...
public class Yacine5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yacine5);
        ...
        text6 = findViewById(R.id.ite6);//erooor
        ...
        premier2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                premier2.setImageResource(R.drawable.barr);
            }
        });
        premier3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                premier3.setImageResource(R.drawable.barrr);
            }
        });
        premier4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                premier4.setImageResource(R.drawable.barrrrr);
        ...
        Intent i = getIntent();
        String jjj = i.getStringExtra(Yacine4.BUTTONS4);
        ...
        razx.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (text1.getText().equals("B") && text2.getText().equals("A") && text3.getText().equals("R") && text4.getText().equals("R") && text5.getText().equals("E") && text6.getText().equals("S")) {
                    // String kkk=textv.getText().toString();
                    SharedPreferences preferenc = getSharedPreferences("pref", 0);
                    SharedPreferences.Editor editor = preferenc.edit();
                    editor.putString(bol5, "vrai");
                    editor.commit();
                    String kkk = textv.getText().toString();
                    Intent secondeActivite = new Intent(Yacine5.this, Yacine6.class);
                    secondeActivite.putExtra(BUTTONS5, pop5);
    ...
    private View.OnClickListener apple = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            raz2.setEnabled(false);
            raz2.setBackgroundColor(Color.RED);
