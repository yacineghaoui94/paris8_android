...
public class Yacine3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yacine3);
...
// mButton2 = (Button) findViewById(R.id.button2);
        ...
        Intent i = getIntent();
        String jjj = i.getStringExtra(Yacine2.BUTTONS2);
        ...
        String la = preferenc.getString(Yacine3.bol3, "11");
        ...
        razx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (text1.getText().equals("S") && text2.getText().equals("A") && text3.getText().equals("L") && text4.getText().equals("U") && text5.getText().equals("T")) {
                    ...
                    editor.commit();
                    Intent secondeActivite = new Intent(Yacine3.this, Yacine.class);
