...
@SuppressLint("NewApi")
public class Yacine10 extends Activity {
    public final static int CHOOSE_BUTTON_REQUEST = 3;
    public final static String BUTTONS4 = "sBoutons";
    public final static String bol10 = "kkons";
    public String pop10 = null;
    int not = 15;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yacine10);
        ...
        String la = preferenc.getString(Yacine10.bol10, "11");
        if (la.toString().equals("vrai")) {
            String ff = textv.getText().toString();
            float dd = Float.valueOf(ff);
            dd = dd - 10;
            pop10 = String.valueOf(dd);
        } else {
            pop10 = textv.getText().toString();
        }
        ...
        razx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (text1.getText().equals("A") && text2.getText().equals("F") && text3.getText().equals("C") && text4.getText().equals("D") && text5.getText().equals("Z")) {
                    ...
                    editor.putString(bol10, "vrai");
                    editor.commit();
                    Intent secondeActivite = new Intent(Yacine10.this, Yacine11.class);
                    secondeActivite.putExtra(BUTTONS4, pop10);
